...
(
    ...
    .save('/mnt/ml-lab/dev_users/sc/ml_campaigns/20250226_apple_se_launch') 
)

# COMMAND ----------

df_campaign_full = spark.read.format("delta").load('/mnt/ml-lab/dev_users/sc/ml_campaigns/20250226_apple_se_launch')
...
df_output_campaign_01 = get_campaign_attr(
    ...
    .withColumn(
        "campaign",
        f.lit("250228-JS-MOBPM-iPhone-SE-Launch")
    )
    # .withColumn(
    #     "campaign_cohort",
...
(
    ...
    .option("overwriteSchema", "true")
    #.option("partitionOverwriteMode", "dynamic")
    .save('/mnt/ml-lab/dev_users/sc/ml_campaigns/wallet/250228-JS-MOBPM-iPhone-SE-Launch') 
)
...
#     .format("snowflake")
#     .options(**options)
#     .option("dbtable", "sc_ml_campaign_wallet_exp_250228_iphone_se_Launch")
#     .mode("overwrite")
#     .save()
# )
...
df_sfmc_export = (
    df_output_campaign
    .filter(f.col("target_cohort") != "Global Control")
    # .withColumn(
...
(
    df_sfmc_export
    .toPandas()
    .to_csv(f"/dbfs{dir_data_sfmc}/250228-JS-MOBPM-iPhone-SE-Launch.csv", index=False)
)

# COMMAND ----------

f"/dbfs{dir_data_sfmc}/250228-JS-MOBPM-iPhone-SE-Launch.csv"

# COMMAND ----------

df_check = spark.read.options(header=True).csv(f"{dir_data_sfmc}/250228-JS-MOBPM-iPhone-SE-Launch.csv")
