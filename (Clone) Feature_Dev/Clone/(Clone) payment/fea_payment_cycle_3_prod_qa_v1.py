...
df_fea_payment = spark.read.format("delta").load(os.path.join(dir_data_fea, "fea_payment_cycle_rolling_3"))
...
display(
    ...
    .agg(
        ...
        , f.avg("payment_amt_tot_1cycle")
        , f.median("payment_amt_tot_1cycle")
        , f.sum("payment_amt_tot_3cycle")
        , f.avg("payment_amt_tot_3cycle")
        , f.median("payment_amt_tot_3cycle")
    )
...
vt_param_group_field = "payment_cycle_rolling_flag"
