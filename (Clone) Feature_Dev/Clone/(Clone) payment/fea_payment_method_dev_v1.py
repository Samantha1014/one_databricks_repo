...
df_prm_payment = spark.read.format("delta").load(os.path.join(dir_data_prm, "prm_payment"))
...
vt_param_payment_table = "prm_payment_mobile_oa_consumer"
vt_param_export_table = "fea_payment_method_6_cycle_rolling_mobile_oa_consumer"
...
vt_param_payment_method_field = "payment_method_main_type_" + str(vt_param_payment_lookback_cycles) + vt_param_payment_cycle_type
vt_param_payment_method_cnt_field = "payment_method_main_cnt_" + str(vt_param_payment_lookback_cycles) + vt_param_payment_cycle_type
vt_param_payment_mehod_pct_field = "payment_mehod_main_pct_" + str(vt_param_payment_lookback_cycles) + vt_param_payment_cycle_type
...
df_base_payment_method_curr = (
    ...
    .withColumnRenamed("payment_method", vt_param_payment_method_field)
    .withColumnRenamed("payment_method_cnt", vt_param_payment_method_cnt_field)
    .withColumnRenamed("payment_method_pct", vt_param_payment_mehod_pct_field)
...
display(df_base_payment_channel_curr.limit(10))
