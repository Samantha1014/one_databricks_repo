...
dir_data_parent_shared = dir_data_parent
dir_data_parent_users = dir_data_parent
...
df_fea_aod = spark.read.format("delta").load(os.path.join(dir_data_fea, "fea_aod"))

# COMMAND ----------

display(df_fea_aod.limit(10))
...
vt_param_group_field = "aod_01to30_flag"
...
vt_param_cnt_field = "fs_acct_id"
vt_param_group_field = "aod_31to60_flag"
vt_param_metric_field = "cnt"
...
vt_param_cnt_field = "fs_acct_id"
vt_param_group_field = "aod_61to90_flag"
vt_param_metric_field = "cnt"
