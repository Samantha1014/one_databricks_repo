...
#dbutils.fs.ls('/mnt/feature-store-prod-lab/d400_feature/d401_mobile_oa_consumer/fea_unit_base')

# fea_ifp_accessory_account
# fea_ifp_accessory_on_bill
# fea_ifp_device_on_bill
# fea_ifp_device_account
# fea_ifp_device_on_service

dbutils.fs.ls('/mnt/feature-store-prod-lab/d300_primary/d301_mobile_oa_consumer//')
...
df_bb_base = (
    ...
    where  
            ...
            and f.d_snapshot_date_key in ('20241031'
            )
            and 
...
# delta_run_node_meta = DeltaTable.forPath(spark,  '/mnt/ml-lab/dev_users/dev_sc/99_misc/cohort_seg/fea_product_acq_hist')
