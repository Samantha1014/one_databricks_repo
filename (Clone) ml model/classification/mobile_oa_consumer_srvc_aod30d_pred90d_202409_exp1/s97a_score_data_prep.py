...
vt_param_mlf_model_data_start_date = '2023-10-31'
vt_param_mlf_model_data_end_date = "2024-07-31"
...
ls_param_mlf_model_data_holdout_date = (
     pd
     .date_range(start = '2023-10-31', end = '2024-07-31', freq = 'M')
     .tolist()
)
...
# customize addon 
dir_data_fs_mvnt = '/mnt/ml-lab/dev_users/dev_sc/aod30_mvnt_v2'
dir_data_fs_aod30 = "/mnt/ml-lab/dev_users/dev_sc/99_misc/df_aod_stauts_v2"
...
export_model_data(
    df_model_holdout
    , '/mnt/ml-lab/dev_users/dev_sc/99_misc/df_model_test_v2'
    , ls_param_fs_reporting_keys
)

# COMMAND ----------

df_test = spark.read.format('delta').load('/mnt/ml-lab/dev_users/dev_sc/99_misc/df_model_test_v2')
